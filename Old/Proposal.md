...
Internal working document for planning, scoping, and quoting.
...
Deliverable:
A working Windows desktop app suitable for real-world testing in Discord/VRChat workflows.
...
Deliverable:
A more refined daily-use tool with better setup, better control, and reduced friction.
...
Deliverable:
A more personalized and enjoyable tool, shaped by real user use rather than assumptions.
...
This is a very discounted/family rate. The important thing is not maximizing price, but protecting scope and expectations.
...
# 5) Recommended Internal Positioning
